...
<link href="css/hyht.css" type="text/css" rel="stylesheet">
<script src="css/prototype.lite.js" type="text/javascript"></script>
<script src="css/moo.fx.js" type="text/javascript"></script>
<script src="css/moo.fx.pack.js" type="text/javascript"></script>
<title>会员右侧</title>
...
<div id="right">
  <div id="r_ts">
    <div class="r_bt">兴趣测评</div>
    
    <!--<div class="r_ts_1" ><a  href="#">解析"211工程"之外的优秀高校</a></div>-->
    
    <div class="clear"></div>
  </div>
  <div id="right_1">
    <!--<div class="r_cp">
      <div class="r_cp_1"><a href="content_list_pingce.php">兴趣测评</a></div>
      <div class="r_cp_2"><a href="member_ceping_xg.php">性格测评</a></div>
    </div>-->
    <div class="r_cp_3" style="margin-top:20px;">
      <div class="r_cp_4" style="background:url(timages/xq1_03.jpg) no-repeat;"></div>
      <div class="r_rightcp_1">
        <div class="r_rightcp_2 hszt">关毅兴趣测评结果</div>
        <div class="clear"></div>
        ...
        <div class="r_rightcp_9"><img src="xqts.php"></div>
 ...
 <p class="r_rightcp_p">根据你最弱的兴趣，你对帮助他人成长、教导他人、为他人提供服务不太感兴趣，因此，在职业生涯规划过程中，一些服务性要求较高的发展方向可能不适合你，比如教师、医生、护士、客服人员、社会工作者等。</p>
        ...
        <div class="dayin"><a href="javascript:(window.print())">打 印</a> <a href="../franchisee/hy_phpword.php?cardid=10121004913" target="_blank">下载报告</a></div>
      </div>
