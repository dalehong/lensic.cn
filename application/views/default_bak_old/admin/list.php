...
<tbody>
    ...
    <tr id="tr_user_<?php echo $data['id']; ?>">
        ...
        <td><a href="<?php echo site_url('admin/admin/edit/' . $data['id']); ?>" title="编辑"><img src="<?php echo SITE_ADMIN_STATIC; ?>/images/edit.gif" alt="编辑" /></a> <a href="javascript:void(0);" onClick="return show_dialog('确定删除该记录吗？', 'del', '<?php echo site_url('admin/admin/del/' . $data['id']); ?>', 'tr_user_<?php echo $data['id']; ?>');" title="删除"><img src="<?php echo SITE_ADMIN_STATIC; ?>/images/del.gif" alt="删除" /></a></td>
    </tr>
    <?php endforeach; ?>
</tbody>
</table>
