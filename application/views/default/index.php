...
<div id="home_container">
	<div id="hc_header">
    	<div id="hch_left"><a href="<?php echo site_url('index/index'); ?>"><!--<img src="<?php echo SITE_ADMIN_LOGO; ?>" />--></a></div>
        <div id="hch_right">
        	<!--
			<div id="hchr_left">
            ...
            <?php endforeach; ?>
                ...
                <a href="<?php echo site_url('index/logout'); ?>" class="top_nav"><img src="<?php echo SITE_ADMIN_STATIC; ?>/images/ico_exit.png" />退出</a>
            </div>
        </div>
        <div class="cls"></div>
    </div>
    <div id="hc_body">
        ...
        <div id="hcb_right"><iframe id="home_iframe" name="home_iframe" src="<?php echo site_url('index/index_info'); ?>" frameborder="0" width="100%" height="100%"></iframe></div>
        <div class="cls"></div>
    </div>
    <div id="hc_footer">
    	<div id="hcf_left">Power By <a id="link_author" class="a_color" href="http://www.xycareer.com/" target="_blank">向阳生涯</a> <!--<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=494686707&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:494686707:52" alt="点击这里给我发消息" title="点击这里给我发消息" style="margin-top: -2px;"></a>--></div>
        <div id="hcf_right">
