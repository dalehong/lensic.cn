...
<div class="content">
	<div class="top">
    	<textarea class="textarea" id="" name="zywt"><?php echo @$fx['zywt'];?></textarea>
    </div>
    <div class="fx_title">
        <h1>职业咨询分析用表</h1>
    </div>
    <div class="fx_name">姓名：<?php echo @$fx['uname'];?></div>
        ...
        if($i=='5'){
        	...
        	echo '<table width="850"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b2b2b2" style="margin-left: 20px;margin-bottom: 20px;">
					  <tr >
					    ...
					    <td width="14%" valign="center" ><p ><input class="input_text" type="text" value="'.$jl[0].'"></p></td>
					    <td width="8%" valign="center" ><p >单位 </p></td>
					    <td width="14%" valign="center" ><p ><input class="input_text" type="text" value="'.$jl[1].'"></p></td>
					    <td width="8%" valign="center" ><p >职务 </p></td>
					    <td width="14%" valign="center" ><p ><input class="input_text" type="text" value="'.$jl[2].'"></p></td>
					    <td width="8%" valign="center" ><p >薪酬 </p></td>
					    <td valign="center" ><p ><input class="input_text" type="text" value="'.$jl[3].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >工作内容 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[4].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >掌握知识 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[5].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >获得技能 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[6].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >关键经历 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[7].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >收获 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[8].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >成就(包括业绩） </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[9].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >弱点 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[10].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >进入原因 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[11].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >离开原因 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[12].'"></p></td>
					  </tr>
					  <tr>
					    <td width="20%" valign="center" ><p >选择标准 </p></td>
					    <td valign="center" colspan="7" ><p ><input class="input_text w2" type="text" value="'.$jl[13].'"></p></td>
					  </tr>
					</table>';
        }else if($i=='6'){
        	$jy=explode('#@#',@$fx['q6']);
        	echo '<table width="850"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b2b2b2" style="margin-left: 20px;margin-bottom: 20px;">
					  ...
					  <tr>
					    <td><p ><input class="input_text" type="text" value="'.$jy[0].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[1].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[2].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[3].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[4].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[5].'" "></p></td>
					  </tr>
					  <tr>
					    <td><p ><input class="input_text" type="text" value="'.$jy[6].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[7].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[8].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[9].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[10].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[11].'" "></p></td>
					  </tr>
					  <tr>
					    <td><p ><input class="input_text" type="text" value="'.$jy[12].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[13].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[14].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[15].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[16].'" "></p></td>
					    <td><p ><input class="input_text" type="text" value="'.$jy[17].'" "></p></td>
					  </tr>
					</table>';
        }else{
