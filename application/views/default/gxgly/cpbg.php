...
<tbody>
    <tr>
        ...
        <td width="6%" >姓名</td>
        <td width="8%">所在院系</td>
        <td width="7%">职业性格 状态</td>
        <td width="8%">完成时间</td>
        <td width="7%">霍兰德 状态</td>
        <td width="8%">完成时间</td>
        <td width="7%">分析问卷 状态</td>
        <td width="8%">完成时间</td>
        <td width="7%">求职能力 状态</td>
        <td width="8%">完成时间</td>
        <td width="7%">创业可行性 状态</td>
        <td width="8%">完成时间</td>
    </tr>
    ...
    <tr id="tr_user_<?php echo $data['mid']; ?>">
        ...
        <td><?php echo $data['qznl_id']?'<a href="'.site_url('gxgly/qznl/' . $data['qznl_id']).'" title="查看报告">查看报告</a>':'尚未测评';?></td>
        <td><?php echo $data['qznl_time']?date("Y-m-d H:i",$data['qznl_time']):'--';?></td>
        <td><?php echo $data['cykxx_id']?'<a href="'.site_url('gxgly/cykxx/' . $data['cykxx_id']).'" title="查看报告">查看报告</a>':'尚未测评';?></td>
