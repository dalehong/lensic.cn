...
<div class="content">
    ...
    <div class="f_body" id="family">
        ...
        <?php endforeach; ?>
        <div class="bb bl br" style="width:180px">
            <input class="input_text" type="text" name="xs2_family[]" title="如：父亲" />
        </div>
        <div class="bb br">
    ...
    <!-- 家庭情况结束 -->
     ...
     <!-- 教育经历 -->
    <div class="f_title" id="f_title">
        <div class="bb br bl" style="width:180px">教育经历</div>
    ...
    <div class="f_body" id="jiaoyu">        
        ...
        <?php endforeach; ?>
        <div class="bb bl br" style="width:180px">
            <input class="input_text" type="text" name="xs3_name[]" value="" title="请填写初中及以上教育经历"/>
        </div>
        <div class="bb br">
	...
	<!-- 社会实践 -->
    <div class="f_title" id="f_title">
        <div class="bb br bl" style="width:180px">社会实践</div>
        <div class="bb br">时间</div>
    ...
    <div class="wenti">
        ...
        <div class="wenti_2 bb br">
            ...
            <input class="input_checkbox" type="checkbox" name="problem[]" value="专业选择" <?php echo in_array('专业选择', $problem_arr)?'checked':'';?> id="b"><label for="b">专业选择</label>&nbsp;&nbsp;
            ...
            <input class="input_checkbox" type="checkbox" name="problem[]" value="职业规划" <?php echo in_array('职业规划', $problem_arr)?'checked':'';?> id="f"><label for="f">职业规划</label>&nbsp;&nbsp;
            ...
            <input class="input_checkbox" type="checkbox" name="problem[]" value="人际关系" <?php echo in_array('人际关系', $problem_arr)?'checked':'';?> id="h"><label for="h">人际关系</label>&nbsp;&nbsp;
    ...
    <div class="miaoshu">
        <div class="miaoshu_1 bb br bl">希望解决</div>
        <div class="miaoshu_2 bb br">
    ...
    <div class="miaoshu">
        <div class="miaoshu_1 bb br bl" style="line-height:18px; padding-top:30px; text-align:center; height:50px; padding-right:0; width:90px">参加过哪些社团</div>
        <div class="miaoshu_2 bb br">
            <textarea class="textarea" id="" name="shetuan" title=""><?php echo $xs1['shetuan'];?></textarea>
        </div>
    </div>
    <div class="miaoshu">
        <div class="miaoshu_1 bb br bl" style="line-height:18px; padding-top:30px; text-align:center; height:50px; padding-right:0; width:90px">参加过哪些培训</div>
        <div class="miaoshu_2 bb br">
            <textarea class="textarea" id="" name="peixun" title=""><?php echo $xs1['peixun'];?></textarea>
        </div>
        <div id="shijian" class="bb br bl clear" style="height:40px; width:1026px; margin-bottom:30px;text-align: center;padding-top: 10px;"><input type="submit" value="确认提交" /></div>   
    </div>
