...
<div class="content">
    ...
    <!-- 学生详细信息 -->
    <div class="wenti">
        <div class="wenti_1 bb br bl" style="height: 120px;line-height:115px;">面临问题</div>
        <div class="wenti_2 bb br" style="height: 120px;line-height: 30px;">
    ...
    <div class="miaoshu">
        ...
        <div class="bb br bl clear" style="height:40px; width:1026px; margin-bottom:30px;text-align: center;padding-top: 10px;"></div> 
    </div>
