...
<?php 
    ...
    for ($i=1,$d=0; $i <=24 ; $i++,$d++) { 
		...
		echo '<div class="'.$bgcolor.'" id="y_xqf_1">
			...
			<div class="zym9"><input type="radio" id="y_xqa_'.$i.'_1" name="mbti'.$i.'" value="3" '.$an1.'/><label for="y_xqa_'.$i.'_1">是</label></div>
			<div class="zym9"><input type="radio" id="y_xqa_'.$i.'_2" name="mbti'.$i.'" value="1" '.$an2.'/><label for="y_xqa_'.$i.'_2">不确定</label></div>
			<div class="zym9"><input type="radio" id="y_xqa_'.$i.'_3" name="mbti'.$i.'" value="0" '.$an3.'/><label for="y_xqa_'.$i.'_3">否</label></div>
			</div>';
    }
?>   
        </div>
