...
<tbody>
    ...
    <tr id="tr_user_<?php echo $data['mid']; ?>">
        ...
        <td><?php echo $data['mbti_id']?'<a href="'.site_url('gsgly/mbti/' . $data['mbti_id']).'" title="查看报告">查看报告</a>':'尚未测评';?></td>
        <td><?php echo $data['mbti_time']?date("Y-m-d H:i",$data['mbti_time']):'--';?></td>
        <td><?php echo $data['hld_id']?'<a href="'.site_url('gsgly/hld/' . $data['hld_id']).'" title="查看报告">查看报告</a>':'尚未测评';?></td>
        <td><?php echo $data['hld_time']?date("Y-m-d H:i",$data['hld_time']):'--';?></td>
        <td><?php echo $data['zyfx_id']?'<a href="'.site_url('gsgly/zyfx/' . $data['zyfx_id']).'" title="查看报告">查看报告</a>':'尚未测评';?></td>
