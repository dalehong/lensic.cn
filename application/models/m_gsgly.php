 ...
 */
class M_gsgly extends CI_Model
{
    ...
    {
        //$this->db->select('admin.*, power_group.group_name')->from('admin')->join('power_group', 'power_group.id = admin.power_group_id');
        $this->db->select('m1.*,m2.uname zxs_name')->from('member m1') -> join('member m2', 'm1.zxsid = m2.mid','left');
        if(isset($arg['search_key']) && $arg['search_key'])
        {
    ...
    {
        $this->db->select('m1.mid,m1.uname,m1.mid,m1.zxbg_id,m1.zxbg_time,m1.zxtime,m2.uname zxs_name')->from('member m1') -> join('member m2', 'm1.zxsid = m2.mid','left');
        if(isset($arg['search_key']) && $arg['search_key'])
        {
            $this->db->like('m1.uname', $arg['search_key']);
        }
