...
<div style="border:1px solid #c5c5c5; margin:20px;padding: 20px;">
    ...
    <div class="bg_mbti">
        ...
        <div class="bg_m_img">
        	<img src="/resources/jpg/MBTI_1.php?E=<?php echo $mbti['E'];?>&I=<?php echo $mbti['I'];?>&S=<?php echo $mbti['S'];?>&N=<?php echo $mbti['N'];?>&T=<?php echo $mbti['T'];?>&F=<?php echo $mbti['F'];?>&J=<?php echo $mbti['J'];?>&P=<?php echo $mbti['P'];?>">
            <img src="/resources/jpg/MBTI_2.php?A=<?php echo $mbti['E']-$mbti['I'];?>&B=<?php echo $mbti['S']-$mbti['N'];?>&C=<?php echo $mbti['T']-$mbti['F'];?>&D=<?php echo $mbti['J']-$mbti['P'];?>">
        </div>
...
概括起来，以下工作是比较适合你的首选，当然并不局限于此：</div>
    ...
    <div style="line-height:2em;"><?php echo @$zxbg['zjjy'];?>			
    </div>
    <div class="h20 clear"></div>
    ...
    <div class="bg_nei"><?php echo @$zxbg['xglj'];?></div>
    <div class="h20 clear"></div>
    ...
    <div class="bg_nei">
        ...
        <div class="bg_nei bg_zydp">评析：<?php echo @$zxbg['lxzy1'];?></div>  
    </div>    
    <div class="bg_nei">
        ...
        <div class="bg_nei bg_zydp">评析：<?php echo @$zxbg['lxzy2'];?></div> 
    </div>    
    <div class="bg_nei">
        ...
        <div class="bg_nei bg_zydp">评析：<?php echo @$zxbg['lxzy3'];?></div>    
    </div>
    ...
    <div class="bg_title">评析：<?php echo @$zxbg['jzgfx'];?></div>
    
    <div class="bg_title">四、职业规划师综合评估意见</div>
    <div class="bg_nei"><?php echo @$zxbg['zhpgyj'];?></div>
