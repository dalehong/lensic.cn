...
<div class="content">
	...
	<div class="q_list">
		...
		<ul>
			...
			<li><input name="q2_S[]" type="checkbox" class="input_checkbox" value="1" id="q2_S_1"/><label for="q2_S_1">1、或单位组织的正式活动</li>
	...
	<div class="q_list">
		...
		<ul>
			...
			<li><input name="q4_S[]" type="checkbox" class="input_checkbox" value="3" id="q4_S_3"/><label for="q4_S_3">2、小学、中学教师</li>
