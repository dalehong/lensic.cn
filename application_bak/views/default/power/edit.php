...
<tbody>
    ...
    <tr>
    	<td class="td_right">权限状态：</td>
        <td class="input_radio_container"><input type="radio" id="radio7" name="status" value="1" /><label for="radio7">正常</label><input type="radio" id="radio8" name="status" value="2" /><label for="radio8">关闭</label></td>
    </tr>
    <tr>
...
stepless_classification('sel_list_show', 'pid[]', '<?php echo base_url(); ?>power/get_cate/', <?php echo $edit_data['pid']; ?>, '/<?php echo $edit_data['id']; ?>');
