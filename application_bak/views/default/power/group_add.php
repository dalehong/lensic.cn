...
<tbody>
    ...
    <tr>
        ...
        <td><input class="input_text" type="text" name="school" id="school" maxlength="100" /></td>
    </tr>
    <tr>
        <td class="td_right">高校组类别：</td>
        <td class="input_radio_container"><input type="radio" id="radio2" name="type" value="0"/><label for="radio2">向阳</label><input type="radio" id="radio3" name="type" value="1"/><label for="radio3">老师</label><input type="radio" id="radio4" name="type" value="2" /><label for="radio4">学生</label></td>
    </tr>
    <tr>
