...
<tbody>
    ...
    <tr>
    	<td class="td_right">所属高校名：</td>
        <td><input class="input_text" type="text" name="school" id="school" maxlength="100" value="<?php echo $edit_data['school']; ?>" /></td>
    </tr>
    <tr>
        <td class="td_right">高校组类别：</td>
        <td class="input_radio_container"><input type="radio" id="radio5" name="type" value="0" /><label for="radio5">向阳</label><input type="radio" id="radio3" name="type" value="1" /><label for="radio3">老师</label><input type="radio" id="radio4" name="type" value="2" /><label for="radio4">学生</label></td>
    </tr>
    <tr>
...
radio_select('type', '<?php echo $edit_data['type']; ?>');
